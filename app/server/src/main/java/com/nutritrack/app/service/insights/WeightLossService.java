...
public class WeightLossService {
    public WeightInsightsDTO getWeightLossInsights(Meal meal) {
        ...
        weightText.setTotalCaloriesInsight(totalCaloriesInsight(totalCalories));
        ...
        weightText.setAverageCaloriesInsight(averageCaloriesInsight(averageCalories));

        //handle total added sugars
        weightNumeric.setTotalAddedSugars(totalAddedSugars);
        weightText.setTotalAddedSugarsInsight(totalAddedSugarsInsight(totalAddedSugars));
        ...
        weightText.setExceedSodiumCarbLimitInsight(sodiumCarbohydrateLimitInsight(exceedSodiumCarbLimit));
        ...
        weightText.setSatietyScoreInsight(satietyScoreInsight(satietyScore));
    ...
    private String totalCaloriesInsight(double totalCalories) {
    ...
    private String averageCaloriesInsight(double averageCalories) {
    ...
    private String totalAddedSugarsInsight(double totalAddedSugars) {
    ...
    private String sodiumCarbohydrateLimitInsight(boolean sodiumCarbohydrateLimit) {
    ...
    private String satietyScoreInsight(double satietyScore) {
